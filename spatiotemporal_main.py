...
edge_list_file = '01_765_200715_TH_0_1_mirrored_edge_list.csv'
win_size = 10
...
gps_file = edge_list_file[:2] + '_all_gps_combined_normalised.csv'
prefix = edge_list_file[:22]
...
preprocess(database, input_file,  gps_data, analysis_type, seperator, win_size)
